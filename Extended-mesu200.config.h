...
#define AP_PASSWORD "albireos"  //  "password", Wifi Access Point password.                                         Adjust
#define AP_CHANNEL 7            //           7, Wifi Access Point channel.                                          Adjust
#define AP_IP_ADDR \
  { 192, 168, 0, 1 }  // ..,168,0,1}, Wifi Access Point IP Address.                                       Adjust
#define AP_GW_ADDR \
  { 192, 168, 0, 1 }  // ..,168,0,1}, Wifi Access Point GATEWAY Address.                                  Adjust
#define AP_SN_MASK \
  { 255, 255, 255, 0 }  // ..55,255,0}, Wifi Access Point SUBNET Mask.                                      Adjust
...
#define STA_IP_ADDR \
  { 192, 168, 1, 55 }  // ..168,1,55}, Wifi Station/Ethernet IP Address.                                   Adjust
#define STA_GW_ADDR \
  { 192, 168, 1, 1 }  // ..,168,1,1}, Wifi Station/Ethernet GATEWAY Address.                              Adjust
#define STA_SN_MASK \
  { 255, 255, 255, 0 }  // ..55,255,0}, Wifi Station/Ethernet SUBNET Mask.                                  Adjust
